...
> **Zeplin provides an easier way to connect components using **Storybook integration**, if your React components already have corresponding stories in a Storybook environment. Check out [this article](https://zpl.io/article/storybook-integration) to learn more.**
